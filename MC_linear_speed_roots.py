...
# #%% Running
# MC = MC_Linear_Speed_Roots()
# MC = MC_Linear_Speed_Roots(Ntimenodes = 200, endtime=10, iterations = 10000)
# MC.run_all_agents()

# #%% simple grapher
# # bins = np.linspace(0, MC.domainsize, 100, endpoint = True)
# # MC.hist_plot(node_number=200, bins=bins)

# #%% Handle the MC data for plotting
...
# df.to_csv (r'D:\Research with Dr Rossi\Python Scratch\Plotting for 1st paper\MC_stationary_toxin_data_hardcoded.csv', index = False, header=True)
# #%% load MC result
# import numpy as np
# import pandas as pd

# data = pd.read_csv(r'D:\Research with Dr Rossi\Python Scratch\Plotting for 1st paper\MC_stationary_toxin_data_hardcoded.csv')
...
# #%% Import analytical sol
# import pandas as pd

# data = pd.read_csv('D:\\Research with Dr Rossi\\Mathematica Scratch\\analytical_w_crossing_logplus18.csv')
...
# #%% Plot analytical sol against MC
...
# ax.plot(x_aly, Sigma_aly, color = 'black', linestyle = linestyle, linewidth=linewidth,
#              label = 'Analytical $\Sigma$')
# ax.set_ylim(0,3)
# ax.set_xlabel("Location")
# ax.set_ylabel("Density")
# ax.legend()
# ax.set_title('Steady State Density, s-1 Has Roots', fontsize=10)
